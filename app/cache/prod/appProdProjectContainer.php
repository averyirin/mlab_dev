...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($a, array('config' => new \Symfony\Bundle\AsseticBundle\Factory\Loader\ConfigurationLoader(), 'twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), $c, false), 'php' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Symfony\Bundle\AsseticBundle\Factory\Loader\AsseticHelperFormulaLoader($a), $c, false)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addEventSubscriber($this->get('gedmo.listener.tree'));
        $b->addEventSubscriber($this->get('gedmo.listener.translatable'));
        $b->addEventSubscriber($this->get('gedmo.listener.timestampable'));
        $b->addEventSubscriber($this->get('gedmo.listener.sluggable'));
        $b->addEventSubscriber($this->get('gedmo.listener.sortable'));
        $b->addEventSubscriber($this->get('gedmo.listener.loggable'));
        ...
        $b->addEventListener(array(0 => 'postPersist'), $a);
        $b->addEventListener(array(0 => 'postUpdate'), $a);
        $b->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'mlab', 'user' => 'mlab', 'password' => 'mlabRocks!1', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_f34095993d696b508b23d68f0f791f0f87405a96c4a29da8c3389ca06cbb050d');
    ...
    {
        $this->services['fos_user.group.controller'] = $instance = new \FOS\UserBundle\Controller\GroupController($this->get('event_dispatcher'), $this->get('fos_user.group.form.factory'), $this->get('fos_user.group_manager'));
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'SinettMLABBuilderBundle', 1 => 'FOSUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
