 ...
 */
class Help extends \Sinett\MLAB\BuilderBundle\Entity\Help implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Help' . "\0" . 'id', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Help' . "\0" . 'route', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Help' . "\0" . 'message'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Help $proxy) {
