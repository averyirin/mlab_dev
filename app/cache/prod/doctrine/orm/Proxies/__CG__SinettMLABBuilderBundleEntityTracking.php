 ...
 */
class Tracking extends \Sinett\MLAB\BuilderBundle\Entity\Tracking implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Tracking' . "\0" . 'id', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Tracking' . "\0" . 'created', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Tracking' . "\0" . 'action', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Tracking' . "\0" . 'payload', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Tracking' . "\0" . 'component', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Tracking' . "\0" . 'user', '' . "\0" . 'Sinett\\MLAB\\BuilderBundle\\Entity\\Tracking' . "\0" . 'app'];
        }
